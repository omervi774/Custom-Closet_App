...
def chat():
    ...
    messages = [
        {"role": "system", "content": "You are a professional cabinet designer. Your answer should always be in dictionary (python) format. Please provide the cabinet design specifications in the following format: {0: [(x1, y1, z), (x2, y2, z), ...], 1: [(x1, y1, z), (x2, y2, z), ...], ...}, where each key represents a layer and the value is a list of cube positions (x, y, z) in that layer. The z-coordinate is always 0! The cabinet must contain at least 2 layers. Each layer contains only the cubes that  Be creative but always follow the rules!"
},
